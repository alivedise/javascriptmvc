...
;(function($){
    ...
    $input
    	...
    	.after(
      	...
      	+ '<div class="' + options.classLabelOff + '"><span><label symbol="text:disabled">'+ options.labelOff + '</label></span></div>'
      	+ '<div class="' + options.classLabelOn + '"><span><label symbol="text:enabled">' + options.labelOn   + '</label></span></div>'
